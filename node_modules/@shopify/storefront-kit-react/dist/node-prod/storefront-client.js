...
function createStorefrontClient({
  ...
  if (storefrontApiVersion !== storefrontApiConstants.SFAPI_VERSION) {
    warnOnce(
      `StorefrontClient: The Storefront API version that you're using is different than the version this build of React Storefront Kit is targeting. You may run into unexpected errors if these versions don't match. Received verion: "${storefrontApiVersion}"; expected version "${storefrontApiConstants.SFAPI_VERSION}"`
    );
  }
  return {
