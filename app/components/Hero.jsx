  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="font-poppins font-semibold xs:text-[36px] ss:text-[68px] text-[52px] text-white xs:leading-[65px] ss:leading-[100.8px] leading-[75px] w-full">
          Exhaust Systems
        </h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          options to manufacture a custom exhaust system that delivers unmatched
          durability.
        </p>
      </div>
      <div className={`flex-1 flex  md:my-0  relative`}>
        <img
          src="/jag-2.png"
          alt="Hero-car"
